...
switch(action.type){
  case 'GET_PRODUCTS':
    newState.initProduct = action.payload;
    break;
    case 'ADD_PRODUCTS':
      newState.initProduct.push(action.payload);
      break;
    default:
      break;
}
